...
*[_type == "event"] | order(eventAt desc) [0...7] {
  _id,
  _createdAt,
  publishedAt,
  eventAt,
...
*[_type == "event"] | order(eventAt desc, _createdAt desc) [0..$limit] {
  ...,
  author->,
  speaker->
}
...
*[_type == "event"] | order(eventAt desc, _createdAt desc) [$pageIndex...$limit] {
  ...,
  speaker->
}
`;
...
*[_type == "event" && slug.current == $slug][0] {
  ...,
  speaker->,
  "related": *[_type == "event" ] | order(eventAt desc, _createdAt desc) [0...5] {
    title,
    slug,
    "date": coalesce(eventAt,_createdAt),
    "image": mainImage
  },
}
`;
...
*[_type == "event" && $slug match speaker->slug.current ] | order(eventAt desc) {
  ...,
  speaker->,
}
`;
