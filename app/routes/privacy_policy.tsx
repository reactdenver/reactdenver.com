export default function PrivacyPolicy() {
  ...
  return <div className='legal'>
    ...
    <p>Tito provides an event management and ticketing platform to its customers ("Event Organisers") that facilitates administration and organisation of these events plus the promotion of the events to, and the purchase of tickets to these events by, potential and actual attendees ("Attendees"). In certain circumstances, Event Organisers may be the controller of certain Attendees' Personal Data. Attendees who are a customer of, or otherwise interact through the Tito Services with, any of our Event Organisers are asked to also read Section 10 of this Privacy Notice.</p>

    <p>For the purposes of this Notice, the controller of your Personal Data is Tito. If you have any questions or concerns about this Notice, please contact our Data Protection Representative Cillian O’Ruanaidh who can be contacted at security@tito.io.</p>

    <h2>Application of this notice</h2>

    <p>IMPORTANT: Please note that this Notice, while intended to be as complete and accurate as reasonably possible, is not exhaustive and may be updated from time to time in accordance with Section 11 of this Notice.</p>

    <p>This Notice applies to the way we collect and process your Personal Data. Personal Data will be collected and processed during the course of our relationship with you and for a period afterward as may be required by applicable law.</p>

    <p>During the course of your dealings with us, we will collect Personal Data:</p>

    <p>For example, when you communicate with us, sign-up to the Tito Services as an Event Organiser, work with us or supply us with services, when you supply Personal Data via our Website or through the Tito Services, submit an enquiry or request support or when you subscribe to or express an interest in any of our newsletters or mailing lists; and from Event Organisers or other third party sources: for example when you are an attendee who expresses an interest in or purchases a ticket to an event promoted by an Event Organiser using the Tito Services, through software platforms we use for business processes, statutory and regulatory authorities, third party service providers and occasionally some additional sources.</p>
    ...
    <ul>
      <li>your use of the Tito Services as an Event Organiser; and</li>
    ...
    <ul>
      ...
      <li>to process your payments, through our third party payment providers; and</li>
      <li>to contact you in relation to any aspect of the Tito Services;</li>
      <li>To create your account for you to use on the Website;</li>
      <li>to process your actions through this account; and</li>
      <li>to otherwise manage and administer your account.</li>
    </ul>

    <p>It is in our legitimate interests to collect and process your Personal Data for the purposes of improving and monitoring website efficiency, enhancing your use of the Website.</p>

    <p>It is also necessary for the purposes of our legitimate interests to process your Personal Data to respond to any queries or requests submitted by you to us.</p>
    ...
    <ul>
      ...
      <li>to ensure the content on the Website is presented in the most effective manner for you and your device.</li>
      <li>To process and respond to any queries or requests you submit to us whether through the Website, by emailing us or otherwise; and</li>
      <li>to seek your views on the Website and our services.</li>
      <li>To build up a profile of you as a user of the Tito services, so that we can analyse and derive insights about who uses the Tito Services and how you use them.</li>
    ...
    <p>Amazon Web Services, who provide us with cloud storage;</p>
    <p>Intercom, who provide us with customer relationship management, messaging and technical support services;</p>
    <p>The list of third party service providers we use may change from time to time as we change or remove some of the providers listed above and/or put in place other providers to assist us in providing the Tito Services. We update our list of third party service providers on https://github.com/teamtito/tito-gdpr-compliance/blob/master/third-parties.md regularly and we would refer you to this as the most up-to-date source of information on our third party service providers.</p>
    ...
    <p>We do not store or process any of your card or payment information. All payment information is processed by our trusted third party payment providers.</p>
    ...
    <p>If you would like to know more about how long we will retain your Personal Data, please contact our Data Protection Representative Cillian O’Ruanaidh who can be contacted at security@tito.io.</p>

    <h2>How we store and safeguard your personal data</h2>
    <p>We care about protecting your information. That's why we put in place appropriate measures that are designed to prevent unauthorised access to, and misuse of, your Personal Data. We also have in place measures to deal with and respond to any suspected data breach.</p>
    ...
    <p>You have the right to request a copy of the Personal Data held by us about you and to access the information which we hold about you. We will only charge you for making such an access request where we feel your request is unjustified or excessive.</p>

    <h3>Right to Rectification</h3>
    <p>ou have the right to have any inaccurate Personal Data which we hold about you updated or corrected.</p>

    <h3>Right to Erasure</h3>
    <p>In certain circumstances, you may also have the Personal Data that we hold about you deleted, for example if you exercise your right to object and we do not have an overriding reason to process your Personal Data or if we no longer require your Personal Data for the purposes set out in this notice.</p>

    <h3>Right to Restriction of Processing</h3>
    <p>You have the right to ask us to restrict processing your Personal Data in certain cases, including if you believe that the Personal Data we hold about you is inaccurate or that our use of your Personal Data is unlawful. If you validly exercise this right, we will store your Personal Data and will not carry out any other processing on it until the issue is resolved.</p>

    <h3>Right to Data Portability</h3>
    <p>You may request us to provide you with your Personal Data which you have given us in a structured, commonly used and machine-readable format and you may request us to transmit your Personal Data directly to another controller where this is technically feasible.</p>

    <p>This right only arises where we process your Personal Data on the legal basis of either your consent or where it is necessary to perform our contract with you and the processing is carried out by automated means.</p>
    ...
    <p>Please note you have the right to object to our processing of your Personal Data for the purposes of sending you marketing and news.</p>

    <p>You can exercise any of these rights by submitting a request to our Data Protection Representative Cillian O’Ruanaidh who can be contacted at security@tito.io.</p>

    <p>We will provide you with information on any action taken in relation to any of these rights upon your request without undue delay and at the latest within 1 month of receiving your request. We may extend this timeframe by one more month if necessary however we will inform you if this arises. Please note that we may ask you to verify your identity when you seek to exercise any of your data protection rights.</p>

    <p>You also have the right to lodge a complaint with the Data Protection Commission. For further information see www.dataprotection.ie.</p>

    <h2>Consumers of our event organisers</h2>
    <p>Tito provides a comprehensive event management platform through which Event Organisers reach out to, communicate with, and sell to Attendees.</p>

    <p>Whenever Tito processes an Attendee's Personal Data on behalf of an Event Organiser, we are acting as a processor, and we therefore conduct such activities strictly in accordance with the instructions of that Event Organiser and pursuant to the contractual arrangements in place with them. If you are an Attendee with an existing relationship with one of our Event Organisers, you should refer to the Event Organiser's website or any terms provided by that Event Organiser to understand their privacy practices and policies. Where you, as an Attendee, would like to exercise your rights in relation to your Personal Data over which the Event Organiser is the controller, you should contact the Event Organiser with such requests. We will cooperate as appropriate with requests from our Event Organisers to assist with such requests.</p>

    <h2>Changes to this notice and questions</h2>
    <p>We may amend this Notice on occasion, in whole or in part, at our sole discretion. Any changes will be effective immediately upon communicating the revised Notice to you.</p>
    ...
    <p>If you have any questions, comments or concerns about the way your Personal Data are being used or processed by Tito, please submit your question, comment or concern in writing to our Data Protection Representative Cillian O’Ruanaidh who can be contacted at security@tito.io.</p>

    <h2>Tito Security Policy</h2>
    <h3>General Web Security</h3>
    <p>All Tito services that store data are hosted by Amazon Web Services, in Ireland.</p>

    <p>All applications use SSL for HTTP transport, without support for compromised cryptographic mechanisms.</p>

    <p>Outside access to services other than those hosted on port 80 and 443 are disabled. All insecure HTTP requests on port 80 are automatically redirected to HTTPS on port 443.</p>
    ...
    <ul>
      ...
      <li>personal information compromised</li>
      <li>recommendations of a follow-on action</li>
